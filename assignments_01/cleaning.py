...
class Assignment01:
    ...
    def clean_data(self):
        ...
        ''' This function reads data from eu_life_expectancy_raw.tsv, filter only data where region equal to PT
        and save the resulting data frame to the data folder as pt_life_expectancy.csv '''
